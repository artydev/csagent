...
public static class HelpDisplay
{
    public static void Show(string version)
    {
        ...
        Console.WriteLine("    --desktopx    Desktop window mode — PhotinoX native window (cross-platform)");
        ...
        Console.WriteLine("    csagent --desktopx                            Desktop window mode (PhotinoX)");
        ...
        Console.WriteLine("    csagent --desktopx --model gpt-4o             DesktopX window with custom model");
